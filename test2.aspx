        ...
        <div class="dashboard">
            ...
            <div class="dashboard-controls">
                <div class="dashboard-controls-left">
                    ...
                    <div class="btn-group" style="height: 35px;">
                        <div class="label-button"
                            style="font-weight: bold; margin-right: 0px; font-size: 14px;align-items:center">
                            Display
                        </div>
                        <div class="btn-group">
                        ...
                        <div id="projectFilterContainer" class="dropdown-menu" aria-labelledby="projectSearchMenuButton">
                            <div id="projectSearchMenu" style="padding: 0px !important;">
                                <button id="projFilterBtn" class="project-filter-button" onclick="showListProjectOption()">
                                    <span>Project</span>
                                    <i class='fas fa-angle-right'style="margin-left:5px !important;"></i>
                                </button>
                    ...
                    <div class="btn-group" style="height: 35px; width:144px;  ">
                        <div class="label-button" style="font-size: 14px; margin-right: 0px; font-weight: bold;width:75px;">Statuses </div>
                    ...
                    <div class="icon-group card-setup-btn" style="margin-left: 10px; height: 35px;">
                ...
                <div class="dashboard-controls-right">
                    ...
                    <label style="font-weight: bold;font-size:14px">Swimlanes Mode:</label>
                    <label class="switch">
